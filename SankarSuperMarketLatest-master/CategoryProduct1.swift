...
class CategoryProduct1 {
    ...
    var ProductvariantList: Array<ProductVariantList1>
    // MARK: Initialization
    
    init?(ID: String, Name: String, Description : String, ProductPhoto: UIImage, Productimgurl: String, ProductvariantList: Array<ProductVariantList1>) {
